...
if __name__ == '__main__':
    ...
    dst1 = Img_Soble(imgGray)
    dst2 = Img_Scharr(imgGray)
    dst3 = Img_Canny(imgGray)

    images = [imgGray, dst1,dst2,dst3]
    titles = ['imgGray','soble','scharr','canny']
    plt.figure('morphology deal')
    for i in range(4):
        plt.subplot(1,4,i+1) #行，列，第几个位置
