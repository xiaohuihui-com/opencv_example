...
if __name__ == '__main__':
    ...
    dst1 = Img_threshold(imgGray,1) # THRESH_BINARY
    dst2 = Img_threshold(imgGray,2) # THRESH_BINARY_INV
    dst3 = Img_threshold(imgGray,3) # THRESH_TRUNC
    dst4 = Img_threshold(imgGray,4) # THRESH_TOZERO
    dst5 = Img_threshold(imgGray,5) # THRESH_TOZERO_INV
    images = [imgGray, dst1,dst2,dst3,dst4,dst5]
    titles = ['imgGray','THRESH_BINARY','THRESH_BINARY_INV','THRESH_TRUNC',
              'THRESH_TOZERO','THRESH_TOZERO_INV']
    plt.figure('threshold deal')
    for i in range(6):
